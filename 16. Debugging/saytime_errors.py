...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 13:25:32 2019
@author: Mehedi Hasan Akash
Github: https://github.com/MehediMehi
"""
# Let's play a game, there are four different errors here. Find and fix them. (1 syntax error, 1 indentation error, 2 runtime)
'''You type a whole bunch of code and that's not working the way you expected to work! You need to have some patience,
   you need to look at it carefully and objectively.'''
# Traceback in python tells where it encoundered an error and it's tracing back it's execution.
